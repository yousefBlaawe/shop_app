...
class Products extends Equatable
{
  ...
  List<Object?> get props => [id, name ,image,oldPrice,discount,description,price,favorites];
...
// "name": "تي شيرت رجالي من Nike NSW Icon Futura, أسود (أسود/أبيض010)، مقاس متوسط",
// "description": "تي شيرت رياضي للرجال من نايك مصنوع من القطن المريح\r\nتي شيرت رياضي من نايك يمنحك الراحة مع قماش جورسيه قطني ناعم وشعار كلاسيكي على الصدر\r\nقماش جورسيه قطني ناعم ومريح",
// "images": [
...
// "description": "نسعي لتقديم منتجات تجمع بين الموضة والحياة العملية حيث يتم تصنيع منتجاتنا من افضل الخامات والتقنيات المبتكرة في مجال الأقمشة والالوان والتصميمات",
// "images": [
...
// "name": "حلقة اضاءة دائرية للبث المباشر والتصوير الاحترافي M-33 مع استدارة 360 درجة 33 سم مع حامل موبايل وحامل ثلاثي 2.1 متر - ابيض و اسود",
// "description": "العلامة التجارية:اخرى\r\nاللون:ابيض اسود\r\nرقم الموديل:M33\r\nالمقاس:33سم\r\nلون الإضاءة:3 الوان من الإضاءة (ابيض,اصفر,دافئ)\r\nمصدر الطاقة:توصيل USB\r\nتشمل:حلقة أضاءة LED ,حامل موبيل , 2.1 متر حامل ثلاثي\r\nاستدارة 360 درجة\r\nمتعدد الاستخدامات\r\nمناسب لصور السيلفي والمصورين والمدونين وفناني الماكياج وما إلى ذلك",
// "images": [
...
// "name": "ضوء ليلي من شاومي مع مستشعر حركي وقاعدة مغناطسية - ابيض",
// "description": "اللون\tاصفر\r\nوزن السلعة\t100 غرامات\r\nالعلامة التجارية\tشاومى\r\nالتجميع مطلوب\tلا\r\nعدد مصادر الضوء\t1\r\nعدد القطع\t1\r\n--------------------------------\r\nحول هذه السلعة\r\nنوع الإنارة : اضواء ليلية\r\nالعلامة التجارية : شاومى\r\n360˚ ضوء ستريو دوار\r\nحساس بعرض 120 درجة\r\nحساس للضوء + جهاز استشعار مزدوج لجسم الإنسان\r\nكشف الحركة البشرية\r\n2- مستويات السطوع\r\n2800K ضوء أصفر دافئ\r\nهيكل مغناطيسي",
// "images": [
...
// "name": "جاكيت رجالي بياقة كولاج بلون موحد",
// "description": "- فئة المنتج: جاكيت\r\n- النمط: كاجوال\r\n- الطول: بأكمام طويلة\r\n- مادة البطانة: بوليستر (PET)\r\n- السماكة: مقطع رقيق\r\n- نوع الإصدار: جسم مناسب\r\n- الحجم: M ، L ، XL ، XXL ، XXXL ، XXXXL ، 5XL\r\n- الألوان: أزرق بني ، أزرق رمادي\r\n- الطول: القسم العام (50 سم - 65 سم)",
// "images": [
...
// }
// ],
// "ad": "https://student.valuxapps.com/storage/uploads/banners/1689106932hsRxm.photo_2023-07-11_23-07-53.png"
// }
// }